SET VERIFY OFF
DEFINE v_script_miembro = 'menu_miembros.sql'
...
ACCEPT v_opc_miembro NUMBER PROMPT '>> Seleccione una opcion (1-6): '

COLUMN script_to_run_mbr NEW_VALUE v_script_miembro
...
END AS script_to_run_mbr FROM DUAL;
