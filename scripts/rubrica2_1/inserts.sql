...
-- 7. Tabla: LECTORES 
    ...
    VALUES (MEA_seq_lectores.NEXTVAL, 99000111, 'Mateo', 'Alejandro', 'Ruiz', 'Gómez', TO_DATE('10-02-2009', 'DD-MM-YYYY'), 'mateo.ruiz@email.com', 9);

    INSERT INTO MEA_LECTORES (id_lector, doc_identidad, p_nombre, s_nombre, p_apellido, s_apellido, f_nacimiento, email, id_lector_repre) 
    VALUES (MEA_seq_lectores.NEXTVAL, 99111222, 'Valentina', 'Isabella', 'Ruiz', 'Gómez', TO_DATE('15-08-2015', 'DD-MM-YYYY'), 'valentina.ruiz@email.com', 10);
